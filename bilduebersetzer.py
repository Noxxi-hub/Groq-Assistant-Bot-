                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": (
                            ...
                            "- If a player name/username is visible before a message, prefix that line with: [NAME: PlayerName]\n"
                            "  Example: [NAME: SaintBrewski] They seem to be falling out okay after that hack kick thing.\n"
                            "- If no player name is visible for a message, do NOT add any name prefix\n"
